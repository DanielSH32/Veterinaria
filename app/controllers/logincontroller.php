...
class LoginController extends Controller {
    // Propiedad para obtener el modelo
    private $user;
    ...
    public function validar() {
        ...
        if ($record) {
            ...
            if ($record["tipo"]=='administrador') {
                $info=array("success"=>true,"msg"=>"Usuario valido","url"=>URL."dashboard");     
            } else {
                $info=array("success"=>true,"msg"=>"Usuario valido","url"=>URL."dashboarduser"); 
            }
        } else {
