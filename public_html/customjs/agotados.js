...
function eventListiners() {
    ...
    document.addEventListener("DOMContentLoaded",cargarDatosAgotados);
}
...
function generarPDF(){
    ...
    frameReporte.src=`${BASE_API}agotados/getReporte?cantidad=3`;
}

function cargarDatosAgotados() {
    API.get("agotados/getAgotados").then(
        data=>{
            if (data.success) {
