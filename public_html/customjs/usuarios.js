        ...
        (item,index)=> {
            if ((index>= recordIni) && (index<=recordFin)) {
                html+=`
                    ...
                    <td>${item.tipo}</td>
                    <td>
                        <button class="btn btn-outline-primary" onClick="editarUsuario(${item.id_usr})"><i class="bi bi-pencil-square"></i></button>
                        <button class="btn btn-outline-danger" onClick="eliminarUsuario(${item.id_usr})"><i class="bi bi-trash"></i></button>
                    </td>
                    </tr>
                `;
            }
